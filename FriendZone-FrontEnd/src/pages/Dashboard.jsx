import { CustomPostCard, CustomSkeleton } from '../components/index.js';
...
import { useFetchPostsLikeAndDislikeStatus, useFetchViews, useFetchDislikesCount, useFetchLikesCount, useFetchPosts } from '../hooks/post/index.js';
...
const Dashboard = () => {
    ...
    const [postState, setPostState] = useState('recommended');
    ...
    const fetchPosts = useFetchPosts(postState, page, limit, setPostState, setHasMore, posts);
    ...
    const getPosts = useCallback(async () => {
        ...
        setLoading(false);
    }, [fetchPosts, postsLikeCount, postsDislikeCount, postsCommentCount, getUsers, postsViewCount, postsLikeAndDislikeStatus, page, likes, dislikes, comments, users, views, likeAndDislike, loading]);
